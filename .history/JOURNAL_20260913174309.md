...
JOUR 2 à 4 — Apprendre Odoo sur un module jetable
...
Création d’un Wizard (Assistant) avec TransientModel.
...
Une ir.rule permet de définir quelles données ces utilisateurs peuvent consulter ou modifier.

L’ordre des fichiers dans **manifest**.py peut être important lorsqu’un fichier dépend d’un autre.

Demain :

Jour 5 — Le squelette du vrai module.
